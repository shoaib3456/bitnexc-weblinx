    ...
    <div>
      <div v-for="(items,key) in tableMoneyShow" class="d-flex flex-column "
        ...
        <div class="py-2 d-flex w-100 flex-column">
          <span class="fw-500">{{items.symbol}} Futures</span>
          <div class="row mx-0 pt-2 pb-2">
            <div class="col-3 px-0 d-flex flex-column align-items-center">
              <span class="fs-8 text-center text-faded-small">Account equity</span>
              <span class="fs-9 text-center">{{ items.usdtBalance.toFixed(5) }}</span>
            </div>
            <div class="col-3 px-0 d-flex flex-column align-items-center">
              <span class="fs-8 text-center text-faded-small">Available margin</span>
              <span class="fs-9 text-center">{{ items.avaBalance.toFixed(5) }}</span>
            </div>
            <div class="col-3 px-0 d-flex flex-column align-items-center">
              <span class="fs-8 text-center text-faded-small">Used margin</span>
              <span class="fs-9 text-center">{{ items.coinBalance.toFixed(5) }}</span>
            </div>
            <div class="col-3 px-0 d-flex flex-column align-items-center">
              <span class="fs-8 text-center text-faded-small">Freeze margin</span>
              <span class="fs-9 text-center">{{ items.coinFrozenBalance.toFixed(5) }}</span>
            </div>
          </div>
        </div>
      </div>
      <div v-if="tableMoneyShow.length < 0" class="py-4 w-100 d-flex justify-content-center align-items fs-8 text-faded-small">
        No Data
      </div>
    </div>
