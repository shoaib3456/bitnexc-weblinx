  ...
  <div>
    ...
    <div v-if="step==0">
      ...
      <div class="p-2 px-3" style="font-size: 11px; opacity: .5;">
        To ensure the security of your account, please complete the real-name
        authentication before trading operations !
      </div>
      <div class=" py-1 d-flex justify-content-between align-items-center ws-filter-tab "
        style="border-bottom: 1px solid #0E151F;">
        <span class="fs-7">Profile Picture</span>
      ...
      <div class=" py-2 d-flex justify-content-between align-items-center ws-filter-tab "
        style="border-bottom: 1px solid #0E151F;">
        <span class="fs-7">Identification</span>
      ...
      <div @click="step=4" class=" py-2 d-flex justify-content-between align-items-center ws-filter-tab "
        style="border-bottom: 1px solid #0E151F;">
        <span class="fs-7">login password</span>
        <div class="d-flex align-items-center">
          <span class="fs-7 text-warning">Edit</span>
          <span class="px-1">
            <b-icon icon="chevron-right" variant="light"></b-icon>
          </span>
        </div>
      ...
      <div @click="step=5" class=" py-2 d-flex justify-content-between align-items-center ws-filter-tab "
        ...
        <span class="fs-7">Fund password</span>
        <div class="d-flex align-items-center">
    ...
    <div v-if="step==3" class="ws-phone-bind">
      ...
      <div>
        <Form ref="formValidate3" class="h-100 " :model="formValidate3" :rules="ruleValidate" :label-width="110">
          <div class="pt-2 col">
            <FormItem label="Country" prop="mobile">
            ...
            <FormItem label="Code" prop="vailCode2">
              <Input v-model="formValidate3.vailCode2" placeholder="Code" size="large">
              <div class="timebox" slot="append">
                <Button @click="send(2)" :disabled="sendMsgDisabled2">
                  <span v-if="sendMsgDisabled2">{{time2+$t('uc.safe.second')}}</span>
                  <span v-if="!sendMsgDisabled2">Send</span>
                </Button>
              </div>
              </Input>
            </FormItem>
            <FormItem label="Login password" prop="password">
              <Input v-model="formValidate3.password" placeholder="login password" size="large" type="password"></Input>
            </FormItem>
          </div>
          <FormItem>
            <Button type="warning" class="w-100" @click="handleSubmit('formValidate3')">Start Binding</Button>
          </FormItem>
        </Form>
      </div>
    </div>
    ...
    <div v-if="step==4" class="ws-phone-bind ws-login-password">
      ...
      <div class="pt-2">
        <Form ref="formValidate4" :model="formValidate4" :rules="ruleValidate" :label-width="95">
          <FormItem label="Old Password" prop="oldPw">
            <Input v-model="formValidate4.oldPw" placeholder="Old Password" size="large" type="password"></Input>
          </FormItem>
          <FormItem label="New Password" prop="newPw">
            <Input v-model="formValidate4.newPw" size="large" placeholder="New Password" type="password"></Input>
          </FormItem>
          <FormItem label="Confirm Password" prop="newPwConfirm">
            <Input v-model="formValidate4.newPwConfirm" size="large" placeholder="Confirm Password"
              type="password"></Input>
          </FormItem>
          <FormItem label="Code" prop="vailCode3">
            <Input v-model="formValidate4.vailCode3" placeholder="Code" size="large">
            <div class="timebox" slot="append">
              <Button @click="send(3)"
                style="padding: 8px 15px 8px;border-bottom-left-radius: unset;border-top-left-radius: unset;"
                :disabled="sendMsgDisabled3">
                <span v-if="sendMsgDisabled3">{{time3+$t('uc.safe.second')}}</span>
                <span v-if="!sendMsgDisabled3">Send</span>
              </Button>
            </div>
            </Input>
          </FormItem>
